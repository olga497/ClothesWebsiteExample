...
namespace ClothesShop.API.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public async Task<IActionResult> IsAuthenticated(string accessToken)
        {
            var mySecret = _configuration["JWT:Secret"];
            var mySecurityKey = new SymmetricSecurityKey(Encoding.ASCII.GetBytes(mySecret));

            var myIssuer = _configuration["JWT:ValidAudience"];
            var myAudience = _configuration["JWT:ValidIssuer"];
        ...
        public async Task<IActionResult> Login([FromBody] LoginModel model)
        {
            ...
            if (user != null && await userManager.CheckPasswordAsync(user, model.Password))
            {
                ...
                var token = new JwtSecurityToken(
                    ...
                    expires: DateTime.Now.AddSeconds(30), // added expiration for the controller
                    claims: authClaims,
